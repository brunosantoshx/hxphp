...
class Request
{
     ...
     */
    public function filter(array $request, string $data, array $custom_filters = []): array
    {
        $filters = [];
    ...
    {
        $session = $this->filter($_SESSION, INPUT_SESSION, $this->custom_filters);
     ...
     * @return bool|string          Retorna um booleano ou o método em si
     */
    public function getMethod(string $value = null): bool
    {
