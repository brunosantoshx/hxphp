...
class Template
{
    ...
    {
        $this->setTemplatePath(TEMPLATES_PATH . 'Helpers' . DS . 'Alert' . DS)->setTemplateFile('alert');
    }

    public function setTemplatePath($path): Template
    {
    ...
    public function setTemplateFile(string $file): Template
    {
