...
class View
{
     ...
     */
    public function setPartialsDir(string $partialsDir, bool $overwrite = false): View
    {
     ...
     */
    public function setPath(string $path, bool $overwrite = false): View
    {
     ...
     */
    public function setTemplate(bool $template): View
    {
     ...
     */
    public function setHeader(string $header, bool $overwrite = false): View
    {
     ...
     */
    public function setFooter(string $footer, bool $overwrite = false): View
    {
     ...
     */
    public function setAssets($type, $assets): View
    {
        (is_array($assets)) ?
